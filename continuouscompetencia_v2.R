...
models<- models %>% mutate(MSE=mse,Accuracy=accuracy)
...
models.validation<- data.frame(cbind(nombres.validation,mse.validation,accuracy.validation))
colnames(models.validation)<-c('modelos','MSE','Accuracy')
